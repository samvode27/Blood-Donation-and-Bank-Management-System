...
const Home = () => {
  ...
  return (
    <>
      {/* Navigation */}
      <nav className="backdrop-blur-md bg-white/80 border-b border-red-100 shadow-lg sticky top-0 z-50 transition-all duration-300">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="flex items-center gap-3 group">
              ...
              <div
                onClick={() => navigate('/')}
                className="cursor-pointer flex items-center justify-center w-12 h-12 bg-gradient-to-r from-red-500 to-red-700 rounded-full shadow-md hover:scale-110 transition duration-300 animate-pulse-soft"
              >
                <i className="fas fa-tint text-white text-xl"></i>
              </div>

              <div className="flex flex-col leading-tight">
                <span className="text-2xl font-extrabold text-red-600 tracking-wide group-hover:tracking-wider transition-all">
                  EthioLife
                </span>
                <span className="text-xs text-gray-500 italic">
                  Ethiopian Blood Bank System
                </span>
              </div>
            ...
            <div className="hidden md:flex items-center space-x-2 lg:space-x-4">
              ...
              {[
                ...
                <a
                  key={index}
                  href={item.link}
                  className="nav-link relative px-3 py-2 text-sm font-semibold transition group">
                  {item.name}
              ...
              <button
                ...
                className="ml-3 flex items-center gap-2 bg-gradient-to-r from-red-500 to-red-700 text-white px-4 py-2 rounded-full text-sm font-medium shadow-md hover:shadow-xl hover:-translate-y-0.5 transition"
              >
              ...
              <button
                ...
                className="flex items-center gap-2 border border-red-500 text-red-600 px-4 py-2 rounded-full text-sm font-medium hover:bg-red-600 hover:text-white transition"
              >
        ...
        {/* Mobile Menu */}
        {mobileOpen && (
          <div className="md:hidden bg-white shadow-lg border-t border-red-100 animate-slideDown">
            <div className="flex flex-col space-y-2 p-4">

              {["Home", "About", "Donate", "Find Blood", "Centers", "Contact"].map((item) => (
                <a
                  key={item}
                  href={`#${item.toLowerCase().replace(" ", "")}`}
                  className="py-2 px-3 rounded-md hover:bg-red-50 hover:text-red-600 font-medium"
                >
                  {item}
                </a>
              ))}

              <button className="mt-2 bg-red-600 text-white py-2 rounded-lg hover:bg-red-700">
                Emergency <i className="fas fa-phone ml-2"></i>
              </button>
      ...
      <section
        id="home"
        className="hero-section relative overflow-hidden pt-28 pb-24 text-white"
      >
            ...
            <div className="space-y-8">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight">
                ...
                <span className="hero-highlight">
                  Save Lives Across Ethiopia
                </span>
              </h1>

              <p className="text-lg text-gray-200 max-w-xl">
                EthioLife Blood Bank connects donors, hospitals, and patients
                to ensure lifesaving blood is available when it matters most.
